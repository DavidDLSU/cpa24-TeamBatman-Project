...
public class DifficultyHard extends Application {
    ...
    private static final int X_TILES = 30;
    private static final int Y_TILES = 16;

    private DifficultyHard.Tile[][] grid = new DifficultyHard.Tile[X_TILES][Y_TILES];
    private Scene scene;
    ...
    private Parent createContent() {
        ...
        for (int y = 0; y < Y_TILES; y++) {
            for (int x = 0; x < X_TILES; x++) {
                DifficultyHard.Tile tile = new DifficultyHard.Tile(x, y, Math.random() < 0.2);
        ...
        for (int y = 0; y < Y_TILES; y++) {
            for (int x = 0; x < X_TILES; x++) {
                DifficultyHard.Tile tile = grid[x][y];
    ...
    private List<DifficultyHard.Tile> getNeighbors(DifficultyHard.Tile tile) {
        List<DifficultyHard.Tile> neighbors = new ArrayList<>();
    ...
    private class Tile extends StackPane {
        ...
        public void open() {
            ...
            if (text.getText().isEmpty()) {
                getNeighbors(this).forEach(DifficultyHard.Tile::open);
            }
        }
